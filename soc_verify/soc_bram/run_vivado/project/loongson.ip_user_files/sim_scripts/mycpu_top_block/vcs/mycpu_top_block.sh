...
#                script (type 'mycpu_top_block.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mycpu_top_block xil_defaultlib.glbl -o mycpu_top_block_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mycpu_top_block_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mycpu_top_block_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mycpu_top_block_simv.daidir vcs_lib c.obj)
