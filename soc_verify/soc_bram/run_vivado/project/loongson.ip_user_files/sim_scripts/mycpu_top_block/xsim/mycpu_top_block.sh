...
#
# Script generated by Vivado on Fri Mar 28 21:29:26 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mycpu_top_block.sh
...
#
# Usage        : mycpu_top_block.sh
#                mycpu_top_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mycpu_top_block.sh [-reset_run]
#                mycpu_top_block.sh [-reset_log]
#                mycpu_top_block.sh [-help]
#
...
# script info
echo -e "mycpu_top_block.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mycpu_top_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mycpu_top_block xil_defaultlib.mycpu_top_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mycpu_top_block -key {Behavioral:sim_1:Functional:mycpu_top_block} -tclbatch cmd.tcl -protoinst "protoinst_files/mycpu_top_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mycpu_top_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mycpu_top_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mycpu_top_block.sh [-help]\n\
Usage: mycpu_top_block.sh [-step]\n\
Usage: mycpu_top_block.sh [-lib_map_path]\n\
Usage: mycpu_top_block.sh [-reset_run]\n\
Usage: mycpu_top_block.sh [-reset_log]\n\
Usage: mycpu_top_block.sh [-keep_index]\n\
Usage: mycpu_top_block.sh [-noclean_files]\n\n\
