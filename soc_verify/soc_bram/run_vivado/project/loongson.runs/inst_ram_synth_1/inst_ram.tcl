...
if { [catch {
  write_verilog -force -mode synth_stub e:/projects_2024/Loong_Team/mycpu_env_try/mycpu_env_try/soc_verify/soc_bram/rtl/xilinx_ip/inst_ram/inst_ram_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub e:/projects_2024/Loong_Team/mycpu_env_try/mycpu_env_try/soc_verify/soc_bram/rtl/xilinx_ip/inst_ram/inst_ram_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim e:/projects_2024/Loong_Team/mycpu_env_try/mycpu_env_try/soc_verify/soc_bram/rtl/xilinx_ip/inst_ram/inst_ram_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim e:/projects_2024/Loong_Team/mycpu_env_try/mycpu_env_try/soc_verify/soc_bram/rtl/xilinx_ip/inst_ram/inst_ram_sim_netlist.vhdl
} _RESULT ] } { 
