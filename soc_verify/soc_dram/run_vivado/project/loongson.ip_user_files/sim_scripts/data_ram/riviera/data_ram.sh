...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Code/CPUshizhan/cdp_ede_local-master/cdp_ede_local-master/mycpu_env/soc_verify/soc_dram/run_vivado/project/loongson.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
