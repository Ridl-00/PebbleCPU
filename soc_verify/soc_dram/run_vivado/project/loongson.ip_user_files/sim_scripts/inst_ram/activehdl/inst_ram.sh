...
#
# Script generated by Vivado on Wed Dec 11 23:57:19 +0800 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/projects_2024/Loong_Team/mycpu_env_try/mycpu_env_try/soc_verify/soc_dram/run_vivado/project/loongson.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
