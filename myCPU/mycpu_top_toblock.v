...
wire [ 1:0]                   csr_plv_out      ;
  ...
  //类SRAM
  // CPU到icache的信号 (icache功能)
  wire                      icache_cpu_req;
  wire                      icache_cpu_wr;
  wire [               3:0] icache_cpu_wstrb;
  wire [               1:0] icache_cpu_size;
  wire [              31:0] icache_cpu_addr;
  wire [              31:0] icache_cpu_wdata;
  wire [              31:0] icache_cpu_rdata;
  wire                      icache_cpu_addr_ok;
  wire                      icache_cpu_data_ok;
  
  // icache到AXI bridge的信号 (icache功能)
  wire                      icache_axi_req;
  wire                      icache_axi_wr;
  wire [               3:0] icache_axi_wstrb;
  wire [               1:0] icache_axi_size;
  wire [              31:0] icache_axi_addr;
  wire [              31:0] icache_axi_wdata;
  wire [              31:0] icache_axi_rdata;
  wire                      icache_axi_addr_ok;
  wire                      icache_axi_data_ok;
  
  // 原始的inst_sram信号 (注释掉，改用icache)
  //wire                      inst_sram_req;
  //wire                      inst_sram_wr;
...
assign csr_to_if_bus = {
  ...
  if_stage u_if_stage (
      ...
      // 使用icache时的连接
      .inst_sram_req    (icache_cpu_req),
      .inst_sram_wr     (icache_cpu_wr),
      .inst_sram_wstrb  (icache_cpu_wstrb),
      .inst_sram_size   (icache_cpu_size),
      .inst_sram_addr   (icache_cpu_addr),
      .inst_sram_wdata  (icache_cpu_wdata),
  ...
  icache u_icache (
      ...
      .cpu_wr           (icache_cpu_wr),
      .cpu_wstrb        (icache_cpu_wstrb),
      .cpu_size         (icache_cpu_size),
      ...
      .axi_wr           (icache_axi_wr),
      .axi_wstrb        (icache_axi_wstrb),
      .axi_size         (icache_axi_size),
      .axi_addr         (icache_axi_addr),
      .axi_wdata        (icache_axi_wdata),
      .axi_addr_ok      (icache_axi_addr_ok),
      .axi_data_ok      (icache_axi_data_ok),
...
assign {
  ...
  axi_bridge u_axi_bridge (
      ...
      // 使用icache时的连接
      .inst_sram_req    (icache_axi_req),
      .inst_sram_wr     (icache_axi_wr),
      .inst_sram_size   (icache_axi_size),
      .inst_sram_wstrb  (icache_axi_wstrb),
      .inst_sram_addr   (icache_axi_addr),
      .inst_sram_wdata  (icache_axi_wdata),
      .inst_sram_addr_ok(icache_axi_addr_ok),
      .inst_sram_data_ok(icache_axi_data_ok),
      .inst_sram_rdata  (icache_axi_rdata),
