...
assign if_to_id_valid    = if_valid & if_ready_go & !(br_really_taken && !preif_excp || (br_taken_r && br_bus_r_valid) && !preif_excp || flush_sign && !preif_excp || if_inst_cancel && !preif_excp);
